using ConfigurationServices.CQRS.Application.Features.SearchConsumers.Commands.CreateSearchConsumer;
using ConfigurationServices.CQRS.Application.Features.SearchConsumers.Commands.DeleteSearchConsumer;
using ConfigurationServices.CQRS.Application.Features.SearchConsumers.Commands.UpdateSearchConsumer;
using ConfigurationServices.CQRS.Application.Features.SearchConsumers.Queries.GetAllSearchConsumers;
using ConfigurationServices.CQRS.Application.Features.SearchConsumers.Queries.GetSearchConsumerByDateBetween;
using ConfigurationServices.CQRS.Application.Features.SearchConsumers.Queries.GetSearchConsumerById;
using ConfigurationServices.CQRS.Application.Features.SearchConsumers.Queries.GetSearchConsumersByDate;
using ConfigurationServices.CQRS.Application.Features.SearchConsumers.Queries.GetSearchConsumersByName;
using ConfigurationServices.CQRS.Application.Features.SearchConsumers.Queries.GetSearchConsumersByPhone;
using MediatR;
