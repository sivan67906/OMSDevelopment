using ConfigurationServices.CQRS.Application.Features.Consumers.Commands.CreateConsumer;
using ConfigurationServices.CQRS.Application.Features.Consumers.Commands.DeleteConsumer;
using ConfigurationServices.CQRS.Application.Features.Consumers.Commands.UpdateConsumer;
using ConfigurationServices.CQRS.Application.Features.Consumers.Queries.GetAllConsumers;
using ConfigurationServices.CQRS.Application.Features.Consumers.Queries.GetConsumerById;
using ConfigurationServices.CQRS.Application.Features.Consumers.Queries.GetConsumerByName;
using ConfigurationServices.CQRS.Application.Features.Consumers.Queries.GetConsumersBySearch;
using MediatR;
