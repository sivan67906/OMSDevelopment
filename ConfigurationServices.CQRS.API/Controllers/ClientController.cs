using ConfigurationServices.CQRS.Application.Feauters.Clients.Commands.CreateClient;
using ConfigurationServices.CQRS.Application.Feauters.Clients.Commands.DeleteClient;
using ConfigurationServices.CQRS.Application.Feauters.Clients.Commands.UpdateClient;
using ConfigurationServices.CQRS.Application.Feauters.Clients.Queries.GetAllClients;
using ConfigurationServices.CQRS.Application.Feauters.Clients.Queries.GetClientById;
using MediatR;
